...
export function Skills() {
  return (
    <section id="skills" className="section-shell">
      <SectionHeading eyebrow="03 / Skills" title="Built on a versatile toolkit." intro="From polished frontend experiences to connected APIs and AI-assisted workflows, these are the tools and practices I bring to my work." />
